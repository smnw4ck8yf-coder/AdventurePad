...
Initial public preview of AdventurePad's AYN Thor dual-display ScummVM companion. See the [historical release notes](https://github.com/smnw4ck8yf-coder/AdventurePad/releases/tag/v0.1.0-preview) for its published binaries and exact scope.
